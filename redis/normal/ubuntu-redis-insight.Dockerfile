# GUI tool: https://redis.io/resources/tools/
# https://docs.redis.com/latest/ri/installing/install-ec2/
FROM ubuntu
...
# docker run redis insight script
COPY ./insight.sh /bin/insight.sh
